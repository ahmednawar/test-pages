...
// Input 2
var config = {app_service_endpoint:"https://ahmed.link.beta.branch.io", link_service_endpoint:"https://ahmed.link.beta.branch.io", api_endpoint:"https://ahmed.api.beta.branch.io", version:"2.18.0"};
// Input 3
...
function compileRequestData(a) {
  ...
  console.log('compileRequestData', a._branchViewData);
  b.data || (b.data = {});
...
Branch.prototype.sendSMS = wrap(callback_params.CALLBACK_ERR, function(a, b, c, d) {
  ...
  g && !d.make_new_link ? e(g.substring(g.lastIndexOf("/") + 1, g.length)) : f._api(resources.link, utils.cleanLinkData(c), function(b, c) {
    ...
    // AHMED
    console.log(d);
    (d = config.link_service_endpoint + "/c/" + utils.extractDeeplinkPath(d));
        console.log(d);
